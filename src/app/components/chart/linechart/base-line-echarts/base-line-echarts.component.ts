...
@Component({
  selector: 'app-base-line-echarts',
  templateUrl: './base-line-echarts.component.html',
  styleUrls: ['./base-line-echarts.component.css']
})
export class BaseLineEchartsComponent implements OnInit {
