...
@Component({
  ...
  styleUrls: ['./smoothed-line-echarts.component.css']
})
export class SmoothedLineEchartsComponent implements OnInit {
 ...
 data:any;
  ...
  selectChangeHandler(event: any) {
   ...
   this._initSmoothedEchart();
 }

private _initSmoothedEchart() {
